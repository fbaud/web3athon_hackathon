...
class GrantCreditScreen extends React.Component {
	...
	componentDidMount(prevProps) {
		console.log('GrantCreditScreen.componentDidMount called');
	...
	async onGotoLink() {
		console.log('GrantCreditScreen.onGotoLink pressed!');
	...
	renderScreen() {
		...
		return (
			<div className="Container">
				<div className="Instructions">Grant Credit.</div>
				<div className="Form">
...
export {GrantCreditScreen};
export default connect(mapStateToProps, mapDispatchToProps)(GrantCreditScreen);